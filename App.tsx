      ...
      <div className="w-full h-full box-border flex flex-col font-sans text-black">
        ...
        <div className="border-t-4 border-black font-bold text-base">
          ...
          <div className="flex items-stretch border-b-2 border-black text-sm">
            <span className="w-[39%] px-2 py-1 border-r-2 border-black flex items-center justify-center">FACTURE N°: {label.invoice}</span>
            <span className="w-[22%] px-1 py-1 border-r-2 border-black flex items-center justify-center">{todayDate}</span>
            <div className="w-[39%] px-2 py-1 flex items-center justify-center">
